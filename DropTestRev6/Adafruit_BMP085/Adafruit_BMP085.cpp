...
boolean Adafruit_BMP085::begin(uint8_t mode) {
  ...
  Wire.begin((int)BMP085_I2CADDR);
  Wire.beginTransmission((int)BMP085_I2CADDR);
  Serial.println(read8(0xD0)); //Read Chip ID
  Serial.println(read8(0xD1)); //Read Chip Version
  Wire.beginTransmission((int)BMP085_I2CADDR);
  Serial.print("End Transmission Error no.  ");
