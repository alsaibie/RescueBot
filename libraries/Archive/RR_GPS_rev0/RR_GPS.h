...
// LLA INITIALIZATION: APPROXIMATE CURRENT LOCATION AND TIME
  #define LLA_INIT F("$PSRF104,33.7912583,-84.4000694,318,96000,269197,1755,12,2*36")
  ...
  class RR_GPS{
	...
	private:
	  ...
	  bool _new_term, _GPRMC_Term_Complete, _PLSR_Term_Complete;
